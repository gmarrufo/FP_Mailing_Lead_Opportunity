...
{
    public class ADX_AccountAccessQueryExp
    {
        ...
        public DataCollection<Entity> Execute(IServiceProvider serviceProvider, Guid gContact, Guid gAccount)
        {
            ...
            */
            ...
            try
            {
                ...
                {
                    Distinct = false,
                    EntityName = Adx_accountaccess.EntityLogicalName,
            ...
            {
                throw new InvalidPluginExecutionException("*****Error in position " + e + "***** ** Error in ADX_AccountAccessQueryExp query : ", ex);
            }
            catch (Exception ex)
            {
                tracingService.Trace("*****Error in position " + e + "***** ** Error in ADX_AccountAccessQueryExp query : {0}", ex.ToString());
                throw;
            }
        }
    }
