...
{
    public class CreateOpportunity : IPlugin
    {
            ...
            if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    ...
                    */
                    ...
                    if (entity.Attributes.Contains("pearl_existingcustomer"))
                    {
                        if (!(bool)entity.Attributes["pearl_existingcustomer"] && (bool)leadRoutingType.pearl_ManualRouting)
                        {
                        ...
                        else if ((bool)entity.Attributes["pearl_existingcustomer"])
                        {
                            distAccount = service.Retrieve(Account.EntityLogicalName, ((EntityReference)entity.Attributes["parentaccountid"]).Id, new ColumnSet(true)).ToEntity<Account>();
                    ...
                    if (distContact != null)
                    {
                        ...
                        /*40*/
                        e++; distAccount.pearl_LastOpportunityAssignment = dToday;//distAccount.Attributes["pearl_lastopportunityassignment"] = dToday;
                        ...
                        entity.Attributes["new_datetoexpire"] = dToday.AddDays((double)foundLead.pearl_Daystoexpire);
                        /*                        
                        Entity
                        ...
                        */
                        ...
                        e++; multipleRequest.Requests.Add(updateRequest);
                        /*e++; CreateRequest createRequest = new CreateRequest { Target = oppPerm1 };
                        e++; multipleRequest.Requests.Add(createRequest);
                        e++; createRequest = new CreateRequest { Target = oppPerm2 };
                        e++; multipleRequest.Requests.Add(createRequest);
                        e++; createRequest = new CreateRequest { Target = accACC };
                        e++; multipleRequest.Requests.Add(createRequest);
                        e++; createRequest = new CreateRequest { Target = conACC };
                        e++; multipleRequest.Requests.Add(createRequest);
                        e++; createRequest = new CreateRequest { Target = chPr };
                        e++; multipleRequest.Requests.Add(createRequest);*/
                ...
                {
                    throw new InvalidPluginExecutionException("** Error in code position: " + e + " ** || *** eText: " + eText + " *** An error occurred in the CreateOpportunity plug-in.", ex);
                }
                catch (Exception ex)
                {
                    tracingService.Trace("** Error in code position: " + e + " ** || *** eText: " + eText + " *** CreateOpportunity: {0}", ex.ToString());
                    throw;
                }
            }
        }
